  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><center><b>DATA VIDEO</b></center></h1>
            <div class="float-right">
              <right><button type="submit" class="btn btn-primary float-right" style="margin-top: 30px; background-color: #fff;"><a href="{{ route('konten.create') }}"><i class="fas fa-plus"> Tambah Video</i></a></button></right>
            </div>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card-body table-responsive p-0">
          <table class="table table table-valign-middle">
            ...
            <tr>
                ...
                <td><video src="{{ asset('uploads/'. $row->konten) }}" width="400px" height="200px" controls></td>
                <td>
                <a href="{{ route('konten.edit', $row->id) }}" class="btn btn-warning btn-sm">
                  <i class="fas fa-edit"></i>
                </a>
                <form action="{{ route('konten.destroy', $row->id) }}" method="post" class="d-inline">
                    @csrf
                    @method('delete')
            ...
            @empty
            <tr>
            <td colspan="7">Video Masih Kosong</td>
            </tr>
            @endforelse
            </tbody>
          </table>
