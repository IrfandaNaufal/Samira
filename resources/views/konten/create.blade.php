                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2" >
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('konten.index') }}" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>FORM VIDEO</b></center></h1>
            <button type="submit" class="btn btn-warning float-right" style="margin: 20px;"><a href="{{ route('konten.index') }}"><i class="right fas fa-angle-left"> Kembali</i></a></button>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('konten.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <p></p>
                        <div class="form-group row">
                            <label for="judul_konten" class="col-sm-2 col-form-label">Judul Video</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="judul_konten" placeholder="Masukkan Judul Video">
                            </div>
                          </div>
                          <div class="form-group row">
                        ...
                        <button type="submit" class="btn btn-primary float-right" style="margin: 20px;">Tambah Video</button>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card-body -->
                  </form>
