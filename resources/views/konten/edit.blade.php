  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>EDIT VIDEO</b></center></h1>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('konten.update', $video->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <p></p>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="judul_konten" id="text" value="{{ $video->judul_konten }}">
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <video src="{{ asset('uploads/'. $video->konten) }}"  width="400px" height="200px" controls>
                            </div>
                          </div>
