...
<html lang="en">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>FORM PRESTASI</b></center></h1>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('prestasi.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <p></p>
                        ...
                        <button type="submit" class="btn btn-primary float-right" style="margin: 20px;">Tambah Prestasi</button>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card-body -->
                  </form>
