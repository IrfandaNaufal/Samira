  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>EDIT PAKET</b></center></h1>
            <button type="submit" class="btn btn-warning float-right" style="margin: 20px;"><a href="{{ route('paket.index') }}"><i class="right fas fa-angle-left"> Kembali</i></a></button>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('paket.update', $paket->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <p></p>
                        <div class="form-group row">
                            <label for="judul_paket" class="col-sm-2 col-form-label">Judul Paket</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="judul_paket" id="text" value="{{ $paket->judul_paket }}">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="angsuran_paket" class="col-sm-2 col-form-label">Angsuran Paket</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="angsuran_paket" id="text" value="{{ $paket->angsuran_paket }}">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="tanggal" class="col-sm-2 col-form-label">Tanggal</label>
                            <div class="col-sm-10">
                            <input type="date" name="tanggal" id="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ $paket->tanggal }}">
                              @error ('tanggal')
                          ...
                          <div class="form-group row">
                            <label for="jumlah_paket" class="col-sm-2 col-form-label">Jumlah Paket</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="jumlah_paket" id="text" value="{{ $paket->jumlah_paket }}">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="gambar_paket" class="col-sm-2 col-form-label">Gambar Paket</label>
                            <div class="col-sm-10">
                              <input type="file" class="form-control" name="gambar_paket">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="gambar_paket" class="col-sm-2 col-form-label">Gambar Saat Ini</label>
                            <div class="col-sm-10">
                            <img src="{{ asset('uploads/'. $paket->gambar_paket) }}" width="200">
                            </div>
                          </div>
