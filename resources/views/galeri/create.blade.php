...
<html lang="en">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>FORM GALERI</b></center></h1>
            <button type="submit" class="btn btn-warning float-right" style="margin: 20px;"><a href="{{ route('galeri.index') }}"><i class="right fas fa-angle-left"> Kembali</i></a></button>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('galeri.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <p></p>
                        <div class="form-group row">
                            <label for="gambar_galeri" class="col-sm-2 col-form-label">Foto Galeri</label>
                            <div class="col-sm-10">
                              <input type="file" class="form-control" name="gambar_galeri">
                            </div>
                          </div>
                        <button type="submit" class="btn btn-primary float-right" style="margin: 20px;">Tambah Galeri</button>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card-body -->
                  </form>
