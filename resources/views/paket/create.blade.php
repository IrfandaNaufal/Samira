  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1><center><b>FORM PAKET</b></center></h1>
          ...
          <section class="col-lg-12">
            <div>
                ...
                <div class="card card-info">
                  <!-- form start -->
                  <form class="form-horizontal" method="post" action="{{ route('paket.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <p></p>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="judul_paket" id="text" placeholder="Masukkan Judul Paket">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="angsuran_paket" class="col-sm-2 col-form-label">Angsuran Paket</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="angsuran_paket" id="text" placeholder="Masukkan Angsuran Paket">
                            </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control" name="jumlah_paket" id="text" placeholder="Masukkan Jumlah Paket">
                            </div>
                          </div>
                          <div class="form-group row">
                        ...
                        <button type="submit" class="btn btn-primary float-right" style="margin: 20px;">Tambah Paket</button>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card-body -->
                  </form>
