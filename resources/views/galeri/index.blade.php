...
<html lang="en">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"><center><b>DATA GALERI</b></center></h1>
            <div class="float-right">
              <right><button type="submit" class="btn btn-primary float-right" style="margin-top: 30px; background-color: #fff;"><a href="{{ route('galeri.create') }}"><i class="fas fa-plus"> Tambah Galeri</i></a></button></right>
            </div>
          </div><!-- /.col -->
      ...
      <div class="card">
        <div class="card-body table-responsive p-0">
          <table class="table table table-valign-middle">
            ...
            <tr>
                <td>{{ $row->id }}</td>
                <td><img src="{{ asset('uploads/'. $row->gambar_galeri) }}" width="100"></td>
                <td>
                <a href="{{ route('galeri.edit', $row->id) }}" class="btn btn-warning btn-sm">
